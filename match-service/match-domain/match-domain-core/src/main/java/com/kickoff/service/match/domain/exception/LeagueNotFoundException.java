...
public class LeagueNotFoundException extends LeagueDomainException {
  ...
  public LeagueNotFoundException(Object... parameters) {
    super(generateMessage(parameters), HTTP_STATUS);
  }

  private static String generateMessage(Object[] parameters) {
    return "[**] League 를 찾을 수 없습니다. : " + String.join(", ", toStringArray(parameters));
  }
